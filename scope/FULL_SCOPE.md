...
| [`iron-man.md`](iron-man.md) | iron-man | Existing EVA editor, private runtime connectors and indexed-save reconstruction, conditional worker `IsKitten` routing, native vessel gauges/button policy, early equipment / late avatar rendering; **default off, native acceptance pending** |
...
and the detailed acceptance checks remain open in [iron-man.md](iron-man.md).
