...
| [`iron-man.md`](iron-man.md) | iron-man | Upright EVA editor/rocket control frame, private runtime connectors and indexed-save reconstruction, conditional worker `IsKitten` routing, native gauges/button policy, geometric backpack RCS, early equipment / late avatar rendering; **default off, native acceptance pending** |
...
native orientation acceptance remains open.
